        ...
        <div class="flex-1 flex flex-col min-w-0 transition-colors duration-300">
            ...
            <header
                ...
                <div class="flex items-center gap-3 lg:gap-6">
                    ...
                    <div class="relative w-48 lg:w-64 hidden md:block">
                        ...
                        <i
                            class="fa-solid fa-magnifying-glass absolute right-3 top-2.5 text-gray-400 dark:text-white text-[10px]"></i>
                    </div>
                    ...
                    <div class="flex items-center gap-2 lg:gap-4">
                        ...
                        <div class="flex items-center gap-3 pl-2 lg:pl-4 border-l border-gray-100 dark:border-slate-800">
                            ...
                            <div
                                class="w-8 h-8 bg-gray-200 dark:bg-slate-700 rounded-full overflow-hidden border border-gray-100 dark:border-slate-800 flex items-center justify-center shrink-0">
            ...
            <main class="flex-1 overflow-y-auto p-4 lg:p-8 custom-scrollbar">
                ...
                <div class="flex flex-col sm:flex-row justify-end gap-3 mb-8 transition-colors">
                    <a href="{{ route('leaderboard.export.excel', request()->query()) }}"
                    ...
                    <a href="{{ route('leaderboard.export.pdf', request()->query()) }}"
