...
<div class="w-full min-h-screen px-4 sm:px-6 lg:px-8 py-6 sm:py-10">
    ...
    <div class="max-w-6xl mx-auto">
        ...
        <!-- JUDUL -->
        <h1 id="judulMateri"
            class="text-xl sm:text-2xl lg:text-3xl font-bold mb-3">
        </h1>

        <!-- DESKRIPSI -->
        <p id="deskripsiMateri"
           class="text-gray-600 mb-5 leading-relaxed text-sm sm:text-base">
        </p>
...
function renderSteps(steps, urutanSelesai) {
    ...
    steps.forEach(step => {
        ...
        let onclickAction = isLocked ? `onclick="alert('Selesaikan materi sebelumnya terlebih dahulu!')"` : `onclick="goToStep(${step.urutan})"`;
        let cursorStyle = isLocked ? "cursor-not-allowed opacity-75" : "cursor-pointer hover:bg-gray-50";
