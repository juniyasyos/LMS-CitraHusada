...
<div class="flex flex-col h-full bg-white dark:bg-slate-900 transition-colors duration-300">
    ...
    <!-- SIDEBAR -->
    <aside
        class="fixed top-0 left-0 w-64 min-h-screen max-h-screen bg-white dark:bg-slate-900 overflow-y-auto z-50 flex flex-col transition-colors duration-300">
    ...
    <!-- MAIN CONTENT -->
    <main class="ml-64 w-full p-6 dark:bg-slate-900 min-h-screen">
        <!-- isi halaman -->
    </main>
